...
router.get('/', async (req, res) => {
    const { url } = req.query;
    const fixedPrompt = `Add dental braces to the person's teeth in this photo. Metal brackets on each tooth with a thin wire connecting them. Make it look realistic and natural, like a real orthodontic treatment. Keep everything else in the photo exactly the same.`; 
